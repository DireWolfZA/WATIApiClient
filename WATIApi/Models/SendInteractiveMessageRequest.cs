...
namespace WATIApi.Models {
    ...
    public partial class SendInteractiveMessageRequest {
        ...
        /// </summary>
        /// <param name="target">
        /// The target recipient in the following formats (required):
        ...
        /// </param>
        /// <param name="type">Message type: &quot;buttons&quot; or &quot;list&quot;. (required).</param>
        /// <param name="buttonMessage">Represents a message with buttons in a conversation.</param>
        /// <param name="listMessage">Represents a list type message in a conversation.</param>
        public SendInteractiveMessageRequest(string target, string type, ButtonsMessage? buttonMessage = null, ListMessage? listMessage = null) {
            this.Target = target ?? throw new ArgumentNullException(nameof(target));
            this.Type = type ?? throw new ArgumentNullException(nameof(target));
