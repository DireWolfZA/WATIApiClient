# WATI API Client [![Build status](https://ci.appveyor.com/api/projects/status/j038b3yff2y10j32)](https://ci.appveyor.com/project/Walkman100/WATIApiClient)
API Client for the WATI v3 WhatsApp API

- API Documentation: https://docs.wati.io/reference
  - Webhooks Documentation: https://docs.wati.io/reference/introduction-1
